...
public class ObjectRepositoryAdapterTest {

	private ObjectRepositoryAdapter instance

	@Before
	void setup() {
		Path objectRepositoryDir = Paths.get(".").resolve("Object Repository")
		instance = new ObjectRepositoryAdapter.Builder(objectRepositoryDir).build()
	}
