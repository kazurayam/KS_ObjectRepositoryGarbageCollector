 ...
 *
 */
public class ObjectRepositoryAdapter {

	private static Logger logger = LoggerFactory.getLogger(ObjectRepositoryAdapter.class)

	private Path objectRepositoryDir
	private List<String> includeFoldersSpecification
	private ObjectRepositoryAccessor accessor

	private ObjectRepositoryAdapter(Builder builder) {
	...
	public static class Builder {
		...
		public ObjectRepositoryAdapter build() {
			assert objectRepositoryDir != null : "objectRepositoryDir is left null"
			return new ObjectRepositoryAdapter(this)
		}
	}
}
