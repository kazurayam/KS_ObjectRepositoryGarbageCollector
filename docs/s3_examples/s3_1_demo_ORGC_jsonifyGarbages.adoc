...
`Test Cases/demo/ObjectRepositoryGarbageCollector/ORGC_jsonifyGarbage`:
[source]
----
include::../Scripts/demo/ObjectRepositoryGarbageCollector/ORGC_jsonifyGarbage/Script1743835392014.groovy[]
----
