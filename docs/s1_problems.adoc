...
Any Katalon project with a lot of unused Test Objects is hard to maintain. Users would want to remove the garbages safely with confidence. Therefore they definitely want a tool that provides a list of unused Test Objects. _Unfortunately Katalon Studio provide no tool to find unused Test Objects._
