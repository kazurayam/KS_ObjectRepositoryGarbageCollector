...
This sample Katalon Studio project has just 15 Test Objects. It is a small project. I believe that many Katalon users have larger projects with 50 Test Objects, 100, 300, ... possibly even more. The more Test Objects you have, the more garbages you would have. The more garbages you have, the more it is difficult to remove them. _Large scale Katalon Studio projects always contain a lot of garbages._

The unused Test Objects make it difficult to maintain Katalon projects clean and readable. Users will want to remove the garbages safely with confidence. Therefore they will want a tool that provides a list of unused Test Objects. _Unfortunately Katalon Studio does not provide a tool to find garbages._
