# KS\_ObjectRepositoryGarbageCollector / Developers' guide

## Project structure

[This repository](https://github.com/kazurayam/KS_ObjectRepositoryGarbageCollector) contains a Gradle [Multi-project](https://docs.gradle.org/current/userguide/intro_multi_project_builds.html).
